def rt():
    import Data_Retrieval_Cla as dt
    ...
    while user_cont[0].lower() == "y":
        ...
        if user_subno[0:3].lower() == "one" or user_subno[0] == "1":
            ...
            if user_desout[0:3].lower() == "bar" or user_desout[0] == "1":
                ...
                plt.show()
                user_cont = input("Would you like to analyse classes again?")
                if user_cont == "":
                    user_cont = "y"
                user_desout_1 = "error"
                user_subno = None
    ...
    '''
    2. taking care of previous records while plotting
        b. Giving the user the option to completely delete the database
    '''
